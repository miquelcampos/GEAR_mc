...
## @package gear.xsi.rig.component.control_02.guide
...
TYPE = "control_02"
NAME = "control"
DESCRIPTION = "Simple controler with rot order selection"
...
class Guide(ComponentGuide):
    ...
    def addParameters(self):
        ...
        self.pRotOrderSel = self.addParam("rotOrderSel", c.siString, "XYZ", None, None)
    ...
    def addLayout(self):
        ...
        group = tab.addGroup("Rot Order")
        group.addEnumControl(self.pRotOrderSel.scriptName, rotOrderItems, "Order of axis", c.siControlCombo)
