...
## @package gear_Synoptic.human_face.parameters
...
def addParameters(prop):
    ...
    par.createOrReturnParameters3(prop, "human_face_path", c.siString, path, None, None, False, False)

    # Selection control parameters
    par.createOrReturnParameters3(prop, "controlers_slidersFace_grp", c.siBool, False, None, None, False, False)
    par.createOrReturnParameters3(prop, "controlers_upperFace_grp", c.siBool, True, None, None, False, False)
    par.createOrReturnParameters3(prop, "controlers_lowerFace_grp", c.siBool, True, None, None, False, False)
