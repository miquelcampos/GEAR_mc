...
TYPE = "neck_ik_02"
NAME = "neck"
DESCRIPTION = "Order rotation changed from the original neck 01.pretty similar to the ik spine with an over top layer of fk controlers that follow the ik position."
